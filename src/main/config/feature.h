...
#define DEFAULT_FEATURES (SET_FEATURE_RX_PPM | SET_FEATURE_INFLIGHT_ACC_CAL | SET_FEATURE_RX_SERIAL | \
        SET_FEATURE_MOTOR_STOP | SET_FEATURE_SERVO_TILT | SET_FEATURE_SOFTSERIAL | SET_FEATURE_GPS |  \
        SET_FEATURE_RANGEFINDER | SET_FEATURE_TELEMETRY | SET_FEATURE_3D | SET_FEATURE_RX_PARALLEL_PWM | \
        SET_FEATURE_RX_MSP | SET_FEATURE_RSSI_ADC | SET_FEATURE_LED_STRIP | SET_FEATURE_DASHBOARD |   \
        SET_FEATURE_OSD | SET_FEATURE_CHANNEL_FORWARDING | SET_FEATURE_TRANSPONDER | SET_FEATURE_AIRMODE | \
        SET_FEATURE_RX_SPI | SET_FEATURE_ESC_SENSOR | SET_FEATURE_ANTI_GRAVITY )
#endif
